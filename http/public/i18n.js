...
const MESSAGES = {
  es: {
    ...
    'booking.stepVerify': 'Paso 2 — Verificar link de prueba',
    'booking.stepVerifyHint':
      'Abra este link en su motor. Debe mostrar 1 adulto, 1 menor, entrada hoy y salida mañana. Si coincide, apruebe. Si no, vuelva a pegar los 3 links.',
    'booking.openVerify': 'Abrir link de verificación',
    ...
    'booking.msgError': 'No pudimos armar un link correcto. Vuelva a pegar los 3 links.',
  ...
  pt: {
    ...
    'booking.stepVerify': 'Passo 2 — Verificar link de teste',
    'booking.stepVerifyHint':
      'Abra este link no seu motor. Deve mostrar 1 adulto, 1 menor, entrada hoje e saída amanhã. Se coincidir, aprove. Se não, cole os 3 links novamente.',
    'booking.openVerify': 'Abrir link de verificação',
    ...
    'booking.msgError': 'Não conseguimos montar um link correto. Cole os 3 links novamente.',
  ...
  en: {
    ...
    'booking.stepVerify': 'Step 2 — Verify test link',
    'booking.stepVerifyHint':
      'Open this link in your engine. It should show 1 adult, 1 child, check-in today and check-out tomorrow. If it matches, approve. If not, paste the 3 links again.',
    'booking.openVerify': 'Open verification link',
    ...
    'booking.msgError': 'We could not build a correct link. Paste the 3 links again.',
