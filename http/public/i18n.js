...
const MESSAGES = {
  es: {
    ...
    'landing.tabSignup': 'Crear mi hotel',
    ...
    'landing.flowTotal':
      'Tiempo total estimado: ~25 min (hoy puedes completar los pasos 1 y 2).',
    'onboarding.title': 'Alta de hotel',
    'onboarding.lead': 'Paso 1 de 5 — comienza aquí.',
    'onboarding.businessName': 'Nombre comercial',
    'onboarding.slug': 'Identificador técnico',
    'onboarding.slugHint': 'Se usa en Qdrant, n8n y base de datos lógica del tenant.',
    'onboarding.email': 'Email (login)',
    'onboarding.password': 'Contraseña',
    'onboarding.language': 'Idioma principal',
    'onboarding.lodgingType': 'Tipo de alojamiento',
    'onboarding.bookingUrl': 'URL de reservas',
    'onboarding.bookingTemplate': 'Plantilla URL reservas (opcional)',
    'onboarding.welcome': 'Mensaje de bienvenida (opcional)',
    'onboarding.submit': 'Crear hotel y entrar',
