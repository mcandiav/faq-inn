...
const MESSAGES = {
  es: {
    ...
    'landing.flowTotal':
      'Crea tu cuenta, vincula WhatsApp con QR y completa tu negocio en Mi cuenta.',
    ...
    'profile.onboardHint':
      'Completa los datos de tu negocio y del agente. Se usan cuando el runtime responde por WhatsApp.',
    ...
    'profile.agentName': 'Nombre del agente',
    'profile.agentNameHint': 'Nombre con el que se presentará el asistente.',
    'profile.welcomeMessage': 'Saludo de bienvenida',
    'profile.welcomeHint': 'Primer mensaje o tono de saludo del agente.',
  ...
  pt: {
    ...
    'landing.flowTotal':
      'Crie sua conta, vincule o WhatsApp com QR e complete seu negócio em Minha conta.',
    ...
    'profile.onboardHint':
      'Complete os dados do seu negócio e do agente. Eles são usados quando o runtime responde pelo WhatsApp.',
    ...
    'profile.agentNameHint': 'Nome com o qual o assistente se apresentará.',
    'profile.welcomeMessage': 'Saudação de boas-vindas',
    'profile.welcomeHint': 'Primeira mensagem ou tom de saudação do agente.',
    'profile.bookingUrl': 'URL de reservas',
  ...
  en: {
    ...
    'landing.flowTotal':
      'Create your account, link WhatsApp with QR, and complete your business in My account.',
    ...
    'profile.onboardHint':
      'Complete your business and agent details. They are used when the runtime replies on WhatsApp.',
    ...
    'profile.agentNameHint': 'Name the assistant will use when introducing itself.',
    'profile.welcomeMessage': 'Welcome greeting',
    'profile.welcomeHint': 'First message or greeting tone for the agent.',
