...
const MESSAGES = {
  es: {
    ...
    'landing.step2Desc': 'Elige objetivo, completa tu negocio y las 3 respuestas iniciales en el asistente de onboarding.',
    ...
    'landing.flowTotal':
      'El alta inicial toma unos 8 minutos. Las respuestas las cargas cuando quieras desde el panel.',
    ...
    'dashboard.hintAdmin':
      'Como administrador, crea posadas en Admin. Los clientes editan sus respuestas.',
    'dashboard.import': 'Importar Excel',
    'dashboard.export': 'Descargar Excel',
    'dashboard.reindex': 'Indexar',
    'dashboard.newFaq': 'Nueva respuesta',
    'dashboard.replaceAll': 'Reemplazar todas las respuestas al importar',
    'dashboard.emptyAdmin': 'Sin respuestas en esta vista.',
    'dashboard.empty': 'Sin respuestas. Importa un Excel o crea la primera.',
    'dashboard.count': '{n} respuestas en total',
    'dashboard.countOne': '1 respuesta en total',
    'dashboard.none': 'Sin respuestas todavía',
    ...
    'unanswered.hint':
      'Abre la respuesta, escribe la respuesta y guarda para crear o actualizar la respuesta desde el mismo modal.',
    ...
    'profile.categoriesHint':
      'Úsalas para ordenar internamente tus respuestas. No influyen en la búsqueda semántica.',
    ...
    'onboarding.stepFaqs': 'Respuestas',
    ...
    'objective.responder_preguntas.description': 'Para negocios que solo necesitan responder dudas y respuestas.',
    ...
    'onboarding.faqsTitle': 'Tus respuestas iniciales',
    ...
    'onboarding.faqsMissing': 'No se cargaron las respuestas iniciales. Usa el botón de abajo o recarga la página.',
    'onboarding.faqsReload': 'Cargar respuestas iniciales',
    ...
    'account.deleteHint':
      'Elimina tu cuenta y todos tus datos (respuestas, motor, conexión de WhatsApp) de forma permanente. Esta acción no se puede deshacer.',
    ...
    'faq.edit': 'Editar respuesta',
    'faq.new': 'Nueva respuesta',
    'faq.newUnanswered': 'Nueva respuesta sin respuesta',
    ...
    'msg.faqNotFound': 'No se encontró la respuesta en la lista. Recarga la página e intenta de nuevo.',
    'msg.deleteFaqConfirm':
      '¿Eliminar esta respuesta?\n\n"{q}"\n\nSe borrará de forma permanente.',
    'msg.deletingFaq': 'Eliminando…',
    'msg.faqDeleted': 'Respuesta eliminada.',
    'msg.reindexConfirm':
      '¿Sincronizar las {n} respuestas actuales con el asistente?\n\nSe actualizará el índice de búsqueda completo.',
    'msg.reindexEmpty':
      '¿Limpiar el índice de búsqueda? No hay respuestas guardadas.',
  ...
  pt: {
    ...
    'landing.flowTotal':
      'O cadastro inicial leva cerca de 8 minutos. As respostas você carrega quando quiser no painel.',
    ...
    'dashboard.hintAdmin':
      'Como administrador, crie pousadas em Admin. Os clientes editam suas respostas.',
    'dashboard.import': 'Importar Excel',
    'dashboard.export': 'Baixar Excel',
    'dashboard.reindex': 'Indexar',
    'dashboard.newFaq': 'Nova resposta',
    'dashboard.replaceAll': 'Substituir todas as respostas ao importar',
    'dashboard.emptyAdmin': 'Sem respostas nesta visualização.',
    'dashboard.empty': 'Sem respostas. Importe um Excel ou crie a primeira.',
    'dashboard.count': '{n} respostas no total',
    'dashboard.countOne': '1 resposta no total',
    'dashboard.none': 'Ainda sem respostas',
    ...
    'unanswered.hint':
      'Abra a resposta, escreva a resposta e salve para criar ou atualizar a resposta no mesmo modal.',
    ...
    'profile.categoriesHint':
      'Use para organizar internamente suas respostas. Não influenciam a busca semântica.',
    ...
    'objective.responder_preguntas.description': 'Para negócios que só precisam responder dúvidas e respostas.',
    ...
    'onboarding.faqOnlyHint':
      'Seu agente só responderá respostas frequentes. Não precisa de motor nem URL.',
    'onboarding.faqsTitle': 'Suas respostas iniciais',
    ...
    'onboarding.faqsMissing': 'As respostas iniciais não carregaram. Use o botão abaixo ou recarregue a página.',
    'onboarding.faqsReload': 'Carregar respostas iniciais',
    ...
    'account.deleteHint':
      'Exclui sua conta e todos os seus dados (respostas, motor, conexão do WhatsApp) de forma permanente. Esta ação não pode ser desfeita.',
    ...
    'table.actions': 'Ações',
    'faq.edit': 'Editar respuesta',
    'faq.new': 'Nova resposta',
    'faq.newUnanswered': 'Nova resposta sem resposta',
    ...
    'msg.faqNotFound': 'Resposta não encontrada na lista. Recarregue a página e tente novamente.',
    'msg.deleteFaqConfirm':
      'Excluir esta resposta?\n\n"{q}"\n\nSerá removida permanentemente.',
    'msg.deletingFaq': 'Excluindo…',
    'msg.faqDeleted': 'Resposta excluída.',
    'msg.reindexConfirm':
      'Sincronizar as {n} respostas atuais com o assistente?\n\nO índice de busca será atualizado por completo.',
    'msg.reindexEmpty':
      'Limpar o índice de busca? Não há respostas salvas.',
  ...
  en: {
    ...
    'landing.flowTotal':
      'Initial setup takes about 8 minutes. You can load answers anytime from the dashboard.',
    ...
    'dashboard.hintAdmin':
      'As administrator, create lodgings in Admin. Clients edit their answers.',
    'dashboard.import': 'Import Excel',
    'dashboard.export': 'Download Excel',
    'dashboard.reindex': 'Index',
    'dashboard.newFaq': 'New answer',
    'dashboard.replaceAll': 'Replace all answers on import',
    'dashboard.emptyAdmin': 'No answers in this view.',
    'dashboard.empty': 'No answers. Import an Excel file or create the first one.',
    'dashboard.count': '{n} answers in total',
    'dashboard.countOne': '1 answer in total',
    'dashboard.none': 'No answers yet',
    ...
    'unanswered.hint':
      'Open the answer, write the answer, and save to create or update the answer from the same modal.',
    'unanswered.filter': 'Status',
    ...
    'profile.categoriesHint':
      'Use them to organize your answers internally. They do not affect semantic search.',
    ...
    'profile.objectiveFaqHint':
      'Answers are always active. The objective defines the assistant\'s main action.',
    ...
    'objective.responder_preguntas.description': 'For businesses that only need to answer questions.',
    ...
    'onboarding.faqOnlyHint':
      'Your agent will only answer frequently asked questions. No engine or URL needed.',
    'onboarding.faqsTitle': 'Your starter answers',
    ...
    'onboarding.faqsMissing': 'Starter answers did not load. Use the button below or reload the page.',
    'onboarding.faqsReload': 'Load starter answers',
    ...
    'account.deleteHint':
      'Permanently delete your account and all your data (answers, engine, WhatsApp connection). This cannot be undone.',
    ...
    'faq.edit': 'Edit answer',
    'faq.new': 'New answer',
    'faq.newUnanswered': 'New answer unanswered',
    ...
    'msg.faqNotFound': 'Answer not found in the list. Reload the page and try again.',
    'msg.deleteFaqConfirm':
      'Delete this answer?\n\n"{q}"\n\nIt will be permanently removed.',
    'msg.deletingFaq': 'Deleting…',
    'msg.faqDeleted': 'Answer deleted.',
    'msg.reindexConfirm':
      'Sync the current {n} answer(s) with the assistant?\n\nThe full search index will be rebuilt.',
    'msg.reindexEmpty':
      'Clear the search index? There are no saved answers.',
