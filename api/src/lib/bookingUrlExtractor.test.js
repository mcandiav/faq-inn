...
test('query params omnibees-like', () => {
  const urls = [
    'https://book.omnibees.com/hotelresults?c=1374&q=2166&NRooms=1&CheckIn=05072026&CheckOut=08072026&ad=2&ch=1&ag=10',
    'https://book.omnibees.com/hotelresults?c=1374&q=2166&NRooms=1&CheckIn=05072026&CheckOut=12072026&ad=3&ch=2&ag=10,11',
    'https://book.omnibees.com/hotelresults?c=1374&q=2166&NRooms=2&CheckIn=05072026&CheckOut=08072026&ad=2&ch=0&ag=',
  ];
...
test('path params compact occupancy', () => {
  const urls = [
    'https://www.pousadamichele.com/search/2026-07-05/2026-07-08/2-10',
    'https://www.pousadamichele.com/search/2026-07-05/2026-07-12/3-10-11',
...
test('rejects different domains', () => {
  const urls = [
    ...
    'https://c.example.com/r?d=05072026',
  ];
  const result = extractBookingTemplate(scenarios, urls);
